<template>
    <div>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" class="m-0 p-0">
            <path fill="#e5f9ff" d="M1260,1.65c-60-5.07-119.82,2.47-179.83,10.13s-120,11.48-180,9.57-120-7.66-180-6.42c-60,1.63-120,11.21-180,16a1129.52,1129.52,0,0,1-180,0c-60-4.78-120-14.36-180-19.14S60,7,30,7H0v93H1440V30.89C1380.07,23.2,1319.93,6.15,1260,1.65Z"></path>
          </svg>
        <div class="container flex justify-center mx-auto" style="background-color: #e5f9ff">
            <div>
                <p class="text-gray-500 text-lg text-center font-normal pb-3">PEOPLES BEHIND <span style="color: #00db80">ACE</span></p>
                <h1 class="xl:text-4xl text-3xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto">The Talented People Behind the Scenes of the Club</h1>
            </div>
        </div>
        <div class="w-full bg-gray-100 px-6 md:px-20 pt-10">
